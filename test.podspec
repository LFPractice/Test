...
Pod::Spec.new do |s|
  ...
  s.description  = "组件化，利用pods制作私有库练习，test test"

  s.homepage     = "https://github.com/LFPractice/Test"
  ...
  s.source       = { :git => "https://github.com/LFPractice/Test.git", :tag => "#{s.version}" }
